...
class SynthesizerAttention(nn.Module):
    ...
    def forward(self, x, layer_past=None):
        ...
        # a vector of features, and the output is also a feature transformed vector
        ...
        softmax_input = relu.view(b, l, h, d//h).transpose(1,2) @ self.w2 + self.b2  # (b, h, l, l)
        softmax_input.masked_fill(self.mask[:,:,:l,:l] == 0, -1e10)
