...
class ParserModel(nn.Module):
    ...
    def forward(self, w):
        ...
        h = self.dropout(F.relu(torch.matmul(x, W) + b1))

        logits = torch.matmul(h, U) + b2
